{application,trackguests3,
    [{modules,
         ['Elixir.Inspect.Trackguests3.Accounts.User','Elixir.Trackguests3',
          ...
          'Elixir.Trackguests3Web',
          'Elixir.Trackguests3Web.AdminLive.Dashboard',
          'Elixir.Trackguests3Web.AdminLive.Persons',
          'Elixir.Trackguests3Web.AdminLive.ResidenceFormComponent',
          'Elixir.Trackguests3Web.AdminLive.Residences',
          'Elixir.Trackguests3Web.AdminLive.Rooms',
          'Elixir.Trackguests3Web.AdminLive.UserFormComponent',
          'Elixir.Trackguests3Web.AdminLive.Users',
          'Elixir.Trackguests3Web.CoreComponents',
          'Elixir.Trackguests3Web.DashboardLive',
          ...
          'Elixir.Trackguests3Web.HistoryController',
          'Elixir.Trackguests3Web.HistoryLive.Index',
          'Elixir.Trackguests3Web.Layouts',
          'Elixir.Trackguests3Web.PageController',
          'Elixir.Trackguests3Web.PageHTML',
          'Elixir.Trackguests3Web.PropertyLive.Dashboard',
          'Elixir.Trackguests3Web.PropertyLive.Form',
          'Elixir.Trackguests3Web.PropertyLive.RoomFormComponent',
          'Elixir.Trackguests3Web.PropertyLive.Rooms',
          'Elixir.Trackguests3Web.PropertyLive.Select',
          ...
          'Elixir.Trackguests3Web.ResidencesLive.Form',
          'Elixir.Trackguests3Web.ResidencesLive.Index',
     ...
     {compile_env,
         [{trackguests3,['Elixir.Trackguests3Web.Gettext'],error},
          {trackguests3,[dev_routes],{ok,true}}]},
     {optional_applications,[]},
     {applications,
         [kernel,stdlib,elixir,logger,runtime_tools,bcrypt_elixir,phoenix,
          phoenix_ecto,ecto_sql,ecto_sqlite3,phoenix_html,phoenix_live_reload,
